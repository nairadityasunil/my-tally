    ...
    <div class="col-sm-12">
        <div class="row">
            ...
            <div class="col-sm-10 py-3">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('search_payable')}}" method="post">
                        @csrf   
                            <div class="col-sm-4">
                                <div class="row">
                                    <div class="col">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <a href="{{url('new_payable')}}">
                                    <button type="button" class="btn _btn"><b>New Payable</b></button>
                                </a>
                            </div>
                            <div class="col-sm-4">
                                <center>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($all_payables as $payables)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('confirm_payable')}}/{{$payables->id}}" class="btn btn-danger" style="border : 0px;">
